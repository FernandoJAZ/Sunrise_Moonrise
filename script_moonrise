// Nuevo selector para la tabla de la Luna
const selectorTabla = '#tb-7dmn'; 
...
if (tabla) {
    ...
    copy(datosCSV);
    console.log(`✅ Datos Lunares de ${mesAnio} copiados al portapapeles.`);
    console.log("➡️ Abre tu Google Sheet y pégalos a continuación de tus datos.");
    console.log("-----------------------------------------");
